...
\section{Desempenho}
Para medir o desempenho da arquitetura, foi utilizado como referência o Google Pixel 2 XL, equipado com o chip Snapdragon 835, sendo este anunciado em 17 de Novembro de 2016 pela Qualcomm Technologies, baseado na arquitetura ARMv8-A. Os testes foram realizados a partir de versões diferentes do Geekbench (2 e 4.4) .
\begin{itemize}
