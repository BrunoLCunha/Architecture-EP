...
\\\\\textbf{SXT[BH] Wd, Wn -} Signed Extend Byte\textbar Halfword: pseudônimo para SBFM Wd,Wn,\#0,\#7\textbar 15. 
\\\\\textbf{SXT[BHW] Xd, Wn -} Signed Extend Byte\textbar Halfword\textbar Word (extended): pseudônimo para SBFM Xd,Xn,\#0,\#7\textbar 15\textbar 31. 
\\\\\textbf{UXT[BH] Wd, Wn -} Unsigned Extend Byte\textbar Halfword: pseudônimo para UBFM Wd,Wn,\#0,\#7\textbar 15. 
\\\\\textbf{UXT[BHW] Xd, Wn -} Unsigned Extend Byte\textbar Halfword\textbar Word (extended): pseudônimo para UBFM Xd,Xn,\#0,\#7\textbar 15\textbar 31. 
